...
func fast(){
	for domain , _ := range server.Routes {
		host := domain
		row("installing  " + domain )
		...
		if(server.Routes[host].Ports!=""){
			...
			for  _,port := range parseRange(server.Routes[host].Ports) {
		...
		server.Routes[host].Name = domain
...
func main(){
	...
	// Print your custom log messages
	log.Println("╔═══════════════════════════════════════════════════════════╗")
	log.Println("║                      KURUYO STARTING                      ║")
	log.Println("╚═══════════════════════════════════════════════════════════╝")
	log.SetFlags(3)
